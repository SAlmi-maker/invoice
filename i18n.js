const JOSKA_I18N = (() => {
  ...
  const translations = {
    en: {
      ...
      'inv.dailyPriceRequired':'Please enter a daily price',
      'inv.dateRangeError':    'End date must be after start date',
      'inv.saved':             'Invoice saved successfully!',
      'inv.savedDraft':        'Invoice saved as draft!',
    ...
    fr: {
      ...
      'inv.pageSubtitle':     'Créez, gérez et exportez les factures de location.',
      ...
      'inv.field.plate':        'Plaque d\'Immatriculation',
      ...
      'inv.dailyPriceRequired':'Veuillez saisir un prix journalier',
      'inv.dateRangeError':    'La date de fin doit être après la date de début',
      'inv.saved':             'Facture enregistrée avec succès !',
      'inv.savedDraft':        'Facture enregistrée comme brouillon !',
      'inv.deleted':           'Facture supprimée avec succès !',
      'inv.saveDraft':         'Enregistrer le Brouillon',
    ...
    ar: {
      ...
      'inv.newInvoiceDesc':  'اتفاقية تأجير و فاتورة',
      ...
      'inv.dailyPriceRequired':'يرجى إدخال السعر اليومي',
      'inv.dateRangeError':    'يجب أن يكون تاريخ النهاية بعد تاريخ البداية',
      'inv.saved':             'تم حفظ الفاتورة بنجاح!',
      'inv.savedDraft':        'تم حفظ الفاتورة كمسودة!',
      'inv.deleted':           'تم حذف الفاتورة بنجاح!',
      'inv.saveDraft':         'حفظ كمسودة',
      'inv.downloadPDF':       'تحميل PDF',
      'inv.deleteTitle':       'حذف الفاتورة',
      'inv.deleteConfirm':     'هل أنت متأكد من حذف هذه الفاتورة؟ لا يمكن التراجع عن هذا الإجراء.',
      'inv.days':             'أيام',
      'inv.preview':          'معاينة',
